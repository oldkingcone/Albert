...
#### Synopsis:
  ...
  All username/password lists are stored within [data](https://github.com/oldkingcone/Albert/tree/master/data) and the functions that leverage the wordlists within this directory are:
